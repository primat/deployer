...
use \Deployer\Build\Entity\Email;
use \Deployer\Build\Entity\Email\Connector;
use \Deployer\Build\Entity\Email\SmtpConnector;
...
class EmailTask extends Task
{
	 ...
	 * @param \Deployer\Build\Entity\Email\Connector $connector
	 * @param \Deployer\Build\Entity\Email $emailData
	 * @throws \Deployer\Build\Exception
	 */
