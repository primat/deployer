...
use \Deployer\Build\Entity\Host;
...
class SshTask extends Task
{
	...
	/**
	 * @param \Deployer\Build\Entity\Host $host
	 * @return \Net_SFTP
...
//	}
	...
	/**
	 * @param \Deployer\Build\Entity\File $localFile
	 * @param \Deployer\Build\Entity\File $remoteFile
	 * @param int $chmod
	 * @throws \Deployer\Build\Exception
	 */
	...
	/**
	 * @param \Deployer\Build\Entity\File $localDumpFile
	 ...
	 * @param \Deployer\Build\Entity\Host $host The host to run the command on
	 ...
	 * @param \Deployer\Build\Entity\File $file
	 * @return bool
	 */
