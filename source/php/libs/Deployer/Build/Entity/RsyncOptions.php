...
use \Deployer\Build\Utils\Cygwin;


/**
 * Class Rsync
 * @package Deployer\Build\Entity\Command
 */
class RsyncOptions
{
	/** @var string $chmod */
	...
	/** @var \Deployer\Build\Entity\Dir|\Deployer\Build\Entity\File $source */
	public $source = '';

	/** @var \Deployer\Build\Entity\Dir|\Deployer\Build\Entity\File $destination */
	public $destination = '';
